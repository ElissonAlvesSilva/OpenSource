...
<div class="container-fluid display-table">
    <div class="row display-table-row">
        ...
        <div class="col-md-10 col-sm-11 display-table-cell valign-top box">
            ...
            <div id="content">
                <header>
                    <h2 class="page_title">Nova Mat�ria</h2>
                </header>
                    ...
                    <div class="form form-wrapper">
                        <form class="form form-horizontal" method="post" name="form">
                            <div class="form-group col-xs-8 col-md-8" style="margin-right: 20px">
                                <label for="nome_materia" class="label label-message">Nome da Mat�ria</label>
                            ...
                            <div class="form-group col-xs-2 col-md-2" style="margin-right: 20px" >
                                <label for="carga" class="label label-message">Carga Hor�ria</label>
                                <input type="text"  class="form-control" id="carga" required name="carga_horaria" maxlength="7" placeholder="ex: 120HRS">
                            </div>
                            <div class="form-group col-xs-2 col-md-2" >
                                <label for="data_criacao" class="label label-message">Data de Cria��o</label>
...
<?php
    if(isset($_POST['cadastrar'])){
        ...
        $verify = $materia->verify('Nome',$_POST['nome']);
              ...
              <div class="modal-dialog">
                <div class="modal-content modal-window">
                  ...
                  <div class="modal-body">
                    <p>Mat�ria <b><i>'.$_POST['nome'].'</i></b> Cadastrado com sucesso</p>
                  </div>
        ...
        <div class="modal fade" id="messagemErr" tabindex="-1" role="dialog">
              <div class="modal-dialog">
                <div class="modal-content modal-window">
                  ...
                  <div class="modal-body">
                    <p>Mat�ria <b><i>'.$_POST['nome'].'</i></b> j� est� cadastrado no sistema.</p>
                  </div>
                  <div class="modal-footer">
