                    ...
                    <div class="form form-wrapper">
                        <form class="form form-horizontal" method="post" name="form">
                            ...
                            <div class="form-group col-xs-12 col-md-12">
                                ...
                                <textarea class="form-control" name="descricao" placeholder="Descri��o sobre a Turma"></textarea>
                            </div>
...
<?php
    if(isset($_POST['cadastrar'])){
        ...
        $verify = $turma->verify('Codigo',$_POST['codigo_turma']);
        if($verify == ''){
              ...
              <div class="modal-dialog">
                <div class="modal-content modal-window">
                  ...
                  <div class="modal-body">
                    <p>Turma <b><i>'.$_POST['codigo_turma'].'</i></b> Cadastrado com sucesso</p>
                  </div>
        ...
        <div class="modal fade" id="messagemErr" tabindex="-1" role="dialog">
              <div class="modal-dialog">
                <div class="modal-content modal-window">
                  ...
                  <div class="modal-body">
                    <p>Turma <b><i>'.$_POST['codigo_turma'].'</i></b> j� est� cadastrado no sistema.</p>
                  </div>
                  <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal" id="button_cad_turma">Fechar</button>
                  </div>
