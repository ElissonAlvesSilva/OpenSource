...
<div class="container-fluid display-table">
    <div class="row display-table-row">
        ...
        <div class="col-md-10 col-sm-11 display-table-cell valign-top box">
            ...
            <div id="content">
                <header>
                    <h2 class="page_title">Atualizar Matéria</h2>
                </header>
                    ...
                    <div class="form form-wrapper">
                        <form class="form form-horizontal" method="post" name="form">
                            <div class="form-group col-xs-8 col-md-8" style="margin-right: 20px">
                                <label for="nome_aluno" class="label label-message">Nome da Matéria</label>
                                <?php
                                if(empty($materia->Nome))
                                    echo '<input type="text"  class="form-control" id="nome_aluno" required name="nome" placeholder="Nome da Materia">';
                                else
                                    echo '<input type="text"  class="form-control" id="nome_aluno" required name="nome" value="'.$materia->Nome.'">';
                                ?>
                            ...
                            <div class="form-group col-xs-2 col-md-2" style="margin-right: 20px" >
                                ...
                                if(empty($materia->Carga_Horaria))
                                    echo '<input type="text"  class="form-control" id="carga" required name="carga_horaria" placeholder="ex. 120HRS">';
                                else
                                    echo '<input type="text"  class="form-control" id="carga" required name="carga_horaria" value="'.$materia->Carga_Horaria.'">';
                                ?>
                            </div>
                            <div class="form-group col-xs-2 col-md-2" >
                                ...
                                if(empty($materia->Data_Criacao))
                                    ...
                                    echo '<input type="text"  class="form-control" id="date_criacao" required name="data_criacao" placeholder="dd/mm/aaaa" value="'.(isset($materia->Data_Criacao)?date('d/m/Y',strtotime($materia->Data_Criacao)):"").'">';
                                ?>
              ...
              <div class="modal-dialog">
                <div class="modal-content modal-window">
                  ...
                  <div class="modal-body">
                    <p>Dados da Mat?ria <b><i>'.$_POST['nome'].'</i></b> atualizado com sucesso</p>
                  </div>
                  <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal" id="button_update_materia">Fechar</button>
                  </div>
                </div><!-- /.modal-content -->
              </div><!-- /.modal-dialog -->
            </div><!-- /.modal -->
