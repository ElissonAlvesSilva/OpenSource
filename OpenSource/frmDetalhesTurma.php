                        ...
                        <div class="form form-wrapper">
                            <form class="form form-horizontal" method="post" name="form">
                                <div class="form-group col-xs-3 col-md-3">
                                    <label class="label-detail">C�digo da Turma</label>
                                    <?php
                                    if(empty($turma->Codigo))
                                        echo '<p class="data">SEM C�digo</p>';
                                    else
                                        echo '<p class="data">'.$turma->Codigo.'</p>';
                                    ?>
                                </div>
                                <div class="form-group col-xs-4 col-md-4">
                                    <label class="label-detail">Mat�ria</label>
                                    <?php
                                    if(empty($turma->Materia_idMateria))
                                        echo '<p class="data">Sem Mat�ria Cadastrada</p>';
                                    else{
                                ...
                                <div class="form-group col-xs-12 col-md-12">
                                    <label class="label-detail">Descri��o da Turma</label>
                                    <?php
