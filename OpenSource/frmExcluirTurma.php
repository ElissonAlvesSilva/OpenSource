    ...
    <div class="container-fluid display-table">
        <div class="row display-table-row">
            ...
            <div class="col-md-10 col-sm-11 display-table-cell valign-top box">
                ...
                <div id="content">
                    <header>
                        <h2 class="page_title">Remover Turma</h2>
                    </header>
                            ...
                            <form class="form form-horizontal" method="post" name="form">
                                ...
                                <div class="form-group col-xs-12 col-md-12">
                                    ...
                                    if(empty($turma->Descricao))
                                        echo '<textarea class="form-control" name="descricao" placeholder="Descrição sobre a Turma"></textarea>';
                                    else
                                        echo '<textarea class="form-control" name="descricao" placeholder="Descrição sobre a Turma">'.$turma->Descricao.'</textarea>';
                                    ?>
              ...
              <div class="modal-dialog">
                <div class="modal-content modal-window">
                  ...
                  <div class="modal-body">
                    <p>Turma <b><i>'.$_POST['codigo_turma'].'</i></b> removida com sucesso</p>
                  </div>
                  <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal" id="button_remove_turma">Fechar</button>
                  </div>
                </div><!-- /.modal-content -->
              </div><!-- /.modal-dialog -->
            </div><!-- /.modal -->
