...
<div class="container-fluid display-table">
    <div class="row display-table-row">
        ...
        <div class="col-md-10 col-sm-11 display-table-cell valign-top box">
            ...
            <div id="content">
                <header>
                    <h2 class="page_title">Buscar Professor</h2>
                </header>
                    ...
                    <div class="form form-wrapper">
                        <table id="tableProfessor" class="display-table">
                            ...
                            if(isset($_POST['buscar'])){
                                ...
                                if($_POST['type'] == 1){
                                    $teacher = $al->findByTypeAll('RA',trim($_POST['filtro']));
                                    foreach ($teacher as $professor){

                                        $detalhes  = "frmDetalhes.php?id=".$professor->idProfessor;
                                        $alterar = "frmUpdateAluno.php?id=".$professor->idProfessor;
                                        $excluir = "frmExcluirAluno.php?id=".$professor->idProfessor;
                                    ...
                                    $teacher = $prof->findByLikeAll('Nome',$_POST['filtro']);
                                    foreach ($teacher as $professor){
