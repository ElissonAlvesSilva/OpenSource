...
$registro_aluno = $reg->findByType('idRegistro',$aluno->RA);
$RA = $registro->RA+1;
...
<div class="container-fluid display-table">
    <div class="row display-table-row">
        ...
        <div class="col-md-10 col-sm-11 display-table-cell valign-top box">
            ...
            <div id="content">
                <header>
                    <h2 class="page_title">Novo Aluno</h2>
                </header>
                    ...
                    <div class="form form-wrapper">
                        <form class="form form-horizontal" method="post" name="form">
                            <div class="form-group col-xs-2 col-md-2"  style="margin-right: 20px">
                                ...
                                <?php
                                    if(empty($aluno->RA))
                                        echo '<input type="text"  class="form-control" id="ra_aluno" required name="ra" placeholder="Registro Academico" value="'.$RA.'">';
                                    else
                                        echo '<input type="text"  class="form-control" id="ra_aluno" required name="ra" value="'.$registro_aluno->RA.'">';
                                ?>
                            ...
                            <div class="form-group col-xs-8 col-md-8" style="margin-right: 200px">
                                ...
                                <?php
                                    if(empty($aluno->Nome_Mae))
                                        echo '<input type="text"  class="form-control" id="nome_aluno" required name="nome_mae" placeholder="Nome Completo">';
                                    else
                                        echo '<input type="text"  class="form-control" id="nome_aluno" required name="nome_mae" value="'.$aluno->Nome_Mae.'">';
                            ...
                            <div class="form-group col-xs-3 col-xs-3" >
                                ...
                                <?php
                                    if(empty($aluno->Data_Nascimento))
                                        ...
                                        value="'.(isset($aluno->Data_Nascimento)?date('d/m/Y',strtotime($aluno->Data_Nascimento)):"").'">';
                                ?>
                            </div>
                            <div class="form-group col-xs-2 col-md-2" style="margin-right: 30px;margin-left: 30px" >
                                ...
                                <?php
                                    if(empty($aluno->RG))
                                        ...
                                        echo '<input type="text"  class="form-control" name="rg" value="'.$aluno->RG.'">';
                                ?>
                            ...
                            <div class="form-group col-xs-4 col-md-4" >
                                ...
                                <?php
                                    if(empty($aluno->CPF))
                                        ...
                                        echo '<input type="text"  class="form-control" id="cpf" maxlength="13"  name="cpf" value="'.$aluno->CPF.'">';
                                ?>
                            ...
                            <div class="form-group col-xs-8 col-md-8" style="margin-right: 200px">
                                ...
                                <?php
                                    if(empty($aluno->Endereco))
                                        ...
                                        echo '<input type="text"  class="form-control" id="nome_aluno" required name="endereco" value="'.$aluno->Endereco.'">';
                                ?>
                            ...
                            <div class="form-group col-md-3 col-xs-3" >
                                ...
                                <?php
                                    if (empty($aluno->Telefone))
                                        ...
                                        echo '<input type="text" class="form-control" id="title" name="telefone" value="'.$aluno->Telefone.'">';
                                ?>
                            ...
                            <div class="form-group col-md-10 col-xs-10" >
                                ...
                                <?php
                                    if(empty($aluno->Email))
                                        ...
                                        echo '<input type="text" class="form-control" id="title" name="email" value="'.$aluno->Email.'">';
                                ?>
    ...
    if(isset($_POST['update'])){
        ...
        $aluno = $aluno->update(
            $id,
                [
                    'RA' => $ra_aluno,
                    'idBiometria' => $_POST['id_biometria'],
                    'Nome' => $_POST['nome'],
